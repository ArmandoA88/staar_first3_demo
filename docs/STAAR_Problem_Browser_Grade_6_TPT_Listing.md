...
STAAR Grade 6 ELAR + Math Problem Browser | HTML Assessment Builder | TEKS

## Description

STAAR Problem Browser is a local assessment-building tool that helps teachers turn released STAAR questions into ready-to-print tests and answer keys in minutes. This Grade 6 edition includes only the Grade 6 ELAR and Grade 6 Math collections.
...
This Grade 6 build includes 2 ready-to-use collections with 902 released items total:

- Grade 6 ELAR - 522 items
- Grade 6 Math - 380 items
...
- Single downloadable HTML file for the Grade 6 app
