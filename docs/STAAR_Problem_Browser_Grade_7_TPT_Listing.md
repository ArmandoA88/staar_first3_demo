...
STAAR Grade 7 ELAR + Math Problem Browser | HTML Assessment Builder | TEKS

## Description

STAAR Problem Browser is a local assessment-building tool that helps teachers turn released STAAR questions into ready-to-print tests and answer keys in minutes. This Grade 7 edition includes only the Grade 7 ELAR and Grade 7 Math collections.
...
This Grade 7 build includes 2 ready-to-use collections with 1,200 released items total:

- Grade 7 ELAR - 804 items
- Grade 7 Math - 396 items
...
- Single downloadable HTML file for the Grade 7 app
...
- Number of Pages or Slides: 1200
- Answer Key: Included
