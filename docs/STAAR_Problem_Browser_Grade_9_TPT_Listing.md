...
STAAR Grade 9 English I ELAR + Algebra I + Biology Problem Browser | HTML Assessment Builder | TEKS

## Description

STAAR Problem Browser is a local assessment-building tool that helps teachers turn released STAAR questions into ready-to-print tests and answer keys in minutes. This Grade 9 edition includes only the English I ELAR, Algebra I Math, and Biology Science collections.
...
This Grade 9 build includes 3 ready-to-use collections with 1,268 released items total:

- English I ELAR - 604 items
- Algebra I Math - 472 items
- Biology Science - 192 items
...
ELAR passage bundles stay linked to their questions, including paired and multi-page passages, so reading selections stay connected to the items that go with them.
...
- Single downloadable HTML file for the Grade 9 app
